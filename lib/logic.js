 ...
 * @param {org.acme.shipping.perishable.ShipmentReceivedAtSupplier} shipmentReceivedAtSupplier - the ShipmentReceivedAtSupplier transaction
 * @transaction
 */
async function receiveShipment(shipmentReceived) {  // eslint-disable-line no-unused-vars
    ...
    console.log('Received at: ' + shipmentReceivedAtSupplier.timestamp);
