...
export class ContractComponent implements OnInit {
  ...
  expiryDateTime = new FormControl('', Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'expiryDateTime': this.expiryDateTime.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.expiryDateTime) {
        formObject.expiryDateTime = result.expiryDateTime;
      } else {
        formObject.expiryDateTime = null;
      }
